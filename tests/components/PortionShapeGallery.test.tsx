...
import PortionShapeGallery from '../../src/components/PortionShapeGallery';
import { PORTION_SHAPES, SHAPE_LABELS } from '../../src/utils/portionShapes';
...
describe('PortionShapeGallery', () => {
  ...
  it('displays shapes in a grid layout', () => {
    ...
    expect(gallery).toHaveClass('portion-shape-gallery');
  });
});
